...
public class ChatServerProcessThread extends Thread{
  ...
  private void doJoin(String nickname, PrintWriter writer) {
    ...
    //login을 위한 부분, 회원가입으로 돌아가기
    if(nickname.equals("adom4311"))
    {
    	String data = nickname + "의 사용자는 존재하지 않습니다. 회원가입 후 진행해 주세요";
    	unicast(data,writer);
    }
    else
    {
  ...
  private void unicast(String data, PrintWriter writer) {
	  writer.println(data);
	  writer.flush();
  }
